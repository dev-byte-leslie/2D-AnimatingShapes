...
GLUTScene::GLUTScene(unsigned int w, unsigned int h)
...
void GLUTScene::resizeEvent(int w, int h)
{
	// Copy the new window dimensions
	activeScene->windowWidth = (unsigned int)w;
	activeScene->windowHeight = (unsigned int)h;
